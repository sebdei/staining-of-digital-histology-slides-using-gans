...
keypoints_1, d1 = sift_detector.detectAndCompute(img1, None)
keypoints_2, d2 = sift_detector.detectAndCompute(img2, None)
...
plt.imshow(img3)
cv2.imwrite('output_sift_matches.jpg', img3)
