...
python3 train.py --dataroot ./datasets/biobanks_pairs_train/biobank4 --name biobank4_hsv_pairs --model pix2pix --load_size 1024 --crop_size 1024 --save_epoch_freq 2 --color_space HSV  --dataset_mode unaligned --serial_batches  --netG resnet_9blocks
