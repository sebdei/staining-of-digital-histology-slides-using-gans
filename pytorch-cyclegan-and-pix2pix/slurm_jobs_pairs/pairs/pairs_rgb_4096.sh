...
#SBATCH --job-name=pairs_rgb_4096
...
python3 train.py --dataroot ./datasets/pairs --name pairs_rgb_4096 --model pix2pix --load_size 4096 --crop_size 1024 --save_epoch_freq 2 --netG resnet_9blocks
