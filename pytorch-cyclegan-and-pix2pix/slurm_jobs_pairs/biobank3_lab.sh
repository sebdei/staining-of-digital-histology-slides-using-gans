...
python3 train.py --dataroot ./datasets/biobanks_pairs_train/biobank3 --name biobank3_lab_pairs --model pix2pix --load_size 1024 --crop_size 1024 --save_epoch_freq 2 --color_space LAB  --dataset_mode unaligned --serial_batches  --netG resnet_9blocks
