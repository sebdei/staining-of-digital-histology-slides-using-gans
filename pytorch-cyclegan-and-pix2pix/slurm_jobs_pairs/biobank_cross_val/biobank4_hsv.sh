...
python3 train.py --dataroot ./datasets/biobanks_pairs/biobank4 --name biobank4_hsv_pairs --model pix2pix --load_size 1024 --crop_size 1024 --save_epoch_freq 2 --color_space HSV    --netG resnet_9blocks
