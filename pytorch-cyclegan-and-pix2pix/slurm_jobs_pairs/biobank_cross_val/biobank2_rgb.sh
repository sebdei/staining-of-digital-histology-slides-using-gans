...
python3 train.py --dataroot ./datasets/biobanks_pairs/biobank2 --name biobank2_rgb_pairs --model pix2pix --load_size 1024 --crop_size 1024 --save_epoch_freq 2    --netG resnet_9blocks
