...
python3 train.py --dataroot ./datasets/biobanks_full/Biobank2 --name biobank2_lab_full --model cycle_gan --load_size 1024 --crop_size 768 --save_epoch_freq 2 --color_space LAB
